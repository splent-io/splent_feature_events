"""
End-to-end tests for splent_feature_events.
...
Run with:  splent feature:test splent_feature_events --e2e
"""
...
def test_index_page_loads(browser):
    ...
    browser.get(f"{host}/splent_feature_events")
    assert "splent_feature_events" in browser.page_source.lower()
